		<!-- Favicon -->
		<link rel="icon" href="{{ !empty(web_setting()->logo_favicon) && CheckFileInServer(web_setting()->logo_favicon) ? web_setting()->logo_favicon : URL::asset('assets\images\icon\favicon.ico') }}" type="image/x-icon"/>
		<link rel="shortcut icon" type="image/x-icon" href="{{ !empty(web_setting()->logo_favicon) && CheckFileInServer(web_setting()->logo_favicon) ? web_setting()->logo_favicon : URL::asset('assets\images\icon\favicon.ico') }}" />
