...
<div class="tab_content active">
    ...
    <div class="form-group {{ ($config['name']) ? "":"d-none" }}">
        <label class="form-label">{{ __('contact_admin.name_company') }}
            (TH)</label>
        <input type="text" class="form-control" name="name_th" placeholder="{{ __('contact_admin.name_company_placeholder') }} (TH)" maxlength="100"
