                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <input type="hidden" name="link_type" id="link_type" value="{{ !empty($data['menu']->link_type)  ? $data['menu']->link_type : 1}}">
                                <input type="hidden" name="slug_id" name="slug_id" value="{{$data['menu']->slug_id ? $data['menu']->slug_id : 0}}">
                               
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('menu_admin.sequence_menu') }}</label>
