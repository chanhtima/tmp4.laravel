...
@section('content')
    ...
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.banner.banner.index') }}">สินค้า</a></li>
            <li class="breadcrumb-item active" aria-current="page">บทความหน้าแรก</li>
        </ol>
    </div>
    <!-- End page-header -->
    ...
    <div class="row">
        <div class="col-md-12">
            <form id="product_detail_frm" name="product_detail_frm" method="POST" onsubmit="setSaveDetail(); return false;"
                enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" id="id" value="{{ !empty($detail->id) ? $detail->id : '0' }}">
                <!-- <div class="card"> -->
                <div class="card">
                    <div class="card-header pb-0">
                        <h3 class="card-title">บทความหน้าแรก</h3>
                    </div>
                                            ...
                                            <div class="content_wrapper">
                                                ...
                                                <div class="tab_content active">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="detail_th" class="form-control texteditor" name="detail_th" rows="4" placeholder="description">{{ !empty($detail->detail_th) ? $detail->detail_th : '' }}</textarea>
                                                    </div>
                                                    {{-- End Input --}}
                                                </div>
                                                {{-- End Tap 1 --}}
                                                ...
                                                <div class="tab_content">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="detail_en" class="form-control texteditor" name="detail_en" rows="4" placeholder="description">{{ !empty($detail->detail_en) ? $detail->detail_en : '' }}</textarea>
                                                    </div>
                                                    {{-- End Input --}}
                                                </div>
                                                {{-- End Tap 2 --}}
...
@section('scripts')
    ...
    <!-- module js css -->
    {{-- <link rel="stylesheet" href="{{ mix('css/product_detail.css') }}"> --}}
