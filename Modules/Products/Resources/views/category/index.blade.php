...
@section('content')
    ...
    <div class="page-header">
        ...
        @if (mwz_roles('admin.product.category.add'))
            <div class="ml-auto">
                <div class="input-group">
                    <a href="{{ route('admin.product.category.add') }}" class="btn btn-secondary text-white mr-2 btn-sm">
                        <span>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="categroy-datatable" class="table table-bordered key-buttons text-nowrap w-100"
                            style="width: 100%">
                            <thead>
                                <tr>
                                    <th class="border-bottom-0" width="5%">ลำดับ</th>
                                    <th class="border-bottom-0" width="15%">รูปภาพ</th>
                                    <th class="border-bottom-0" width="20%">ชื่อหมวดหมู่ th</th>
                                    <th class="border-bottom-0" width="20%">ชื่อหมวดหมู่ en</th>
                                    <th class="border-bottom-0" width="15%">อัพเดทล่าสุด</th>
                                    <th class="border-bottom-0" width="25%">จัดการ</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
