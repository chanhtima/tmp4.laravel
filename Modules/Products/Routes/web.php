...
Route::group(['middleware' => 'auth:admin'], function () {
    Route::prefix('admin/product')->group(function () {
        ...
        Route::prefix('category')->group(function () {
            Route::get('/', 'ProductCategoryAdminController@index')->name('admin.product.category.index');
            Route::get('/datatable_ajax', 'ProductCategoryAdminController@datatable_ajax')->name('admin.product.category.datatable_ajax');

            Route::get('/add', 'ProductCategoryAdminController@form')->name('admin.product.category.add');
            Route::get('/edit/{id}', 'ProductCategoryAdminController@form')->name('admin.product.category.edit');
            Route::post('/save', 'ProductCategoryAdminController@save')->name('admin.product.category.save');
            Route::post('/set_re_order', 'ProductCategoryAdminController@set_re_order')->name('admin.product.category.set_re_order');

            Route::post('/set_status', 'ProductCategoryAdminController@set_status')->name('admin.product.category.set_status');
            Route::post('/set_delete', 'ProductCategoryAdminController@set_delete')->name('admin.product.category.set_delete');
            Route::post('/set_status_menu_footer', 'ProductCategoryAdminController@set_status_menu_footer')->name('admin.product.category.set_status_menu_footer');
        });
    });
});
