            ...
            <div class="tab_content">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <!-- upload image footer -->
                        <div class="form-group">
                            <?= image_upload($id = '2', $name = 'logo_footer', $label = __('websetting_admin.upload_image_header'), $image = !empty($setting->logo_footer) ? $setting->logo_footer : '', $size_recommend = '254 x 22p',false,true) ?>
                        </div>
            ...
            <div class="tab_content">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="mb-2">
                            <div class="form-group">
                                <?= image_upload($id = '3', $name = 'logo_favicon', $label = __('websetting_admin.upload_image_header') . ' Favicon', $image = !empty($setting->logo_favicon) ? $setting->logo_favicon : '', $size_recommend = '32 x 32px',false,true) ?>
                            </div>
                        </div>
                        {{-- end input --}}
                    </div>
