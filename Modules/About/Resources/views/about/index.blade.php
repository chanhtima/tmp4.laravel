...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <form id="about_detail_frm" name="about_detail_frm" method="POST" onsubmit="setSaveDetail(); return false;"
                enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" id="id" value="{{ !empty($about->id) ? $about->id : '0' }}">
                <!-- <div class="card"> -->
                <div class="card">
                    <div class="card-header pb-0">
                        <h3 class="card-title">{{ __('about_admin.about_data') }}หน้าาแรก</h3>
                    </div>
                                        ...
                                        <div class="mb-2">
                                            <div class="form-group">
                                                <?= image_upload(
                                                    ...
                                                    $image = (!empty($about->image))?$about->image:'', 
...
@section('scripts')
    ...
    <!-- module js css -->
    <link rel="stylesheet" href="{{ mix('css/about_detail.css') }}">
    <script src="{{ mix('js/about_detail.js') }}"></script>
@endsection
